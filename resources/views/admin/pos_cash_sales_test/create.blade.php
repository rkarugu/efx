                ...
                <div class = "col-sm-3">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input class="form-control customer_name_enter" placeholder="Enter Name" name="customer_name" type="text">
                        </div>
                    </div>
                </div>
                ...
                <div class = "col-sm-3">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input class="form-control customer_name_enter" placeholder="Customer PIN" name="customer_pin" type="text">
                        </div>
                    </div>
                </div>
                ...
                <div class = "col-sm-3">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input class="form-control customer_name_enter" placeholder="Customer Phone No." name="customer_phone_number" type="text">
                        </div>
                    </div>
                </div>
